    ...
    <div>
      <div>
        ...
        <ul>
          ...
          <li>
            <strong>National Domestic Violence Hotline: </strong> 1-
            800-799-7233
          </li>
          <li>
          ...
          <li>
            <strong>National Hopeline Network: </strong>1-800-SUICIDE
            (800-784-2433)
          </li>
          <li>
          ...
          <li>
            <strong>GLBT Hotline: </strong>1-888-843-4564
          </li>
          <li>
          ...
          <li>
            ...
            <a>https://suicidepreventionlifeline.org/chat/</a>
          </li>
          <li>
            <strong>Essential local and community services: 211, </strong>
            <a>https://www.211.org/</a>
          </li>
          <li>
            <strong>Veterans Crisis Line: </strong>
            <a>https://www.veteranscrisisline.net</a>
          </li>
          <li>
            <strong>Suicide Prevention Wiki: </strong>
            <a>http://suicideprevention.wikia.com</a>
          </li>
          <li>
      ...
      <div>
        ...
        <ul>
          <li>
            <strong>Emergency </strong>112 or 999
          </li>
          <li>
            <strong>Non-emergency: </strong>111, Option 2{" "}
          </li>
          <li>
            <strong>24/7 Helpline: </strong>116 123 (UK and ROI){" "}
          </li>
          <li>
            <strong>Shout: </strong>Text "DESERVE" TO 85258
          </li>
          <li>
            <strong>Samaritans.org: </strong>
            <a>https://www.samaritans.org/how-we-can-help-you/contact-us</a>
          </li>
          <li>
      ...
      <div>
        ...
        <ul>
          <li>
            <strong>Argentina Suicide Hotline: </strong> +5402234930430
          </li>
          <li>
            <strong>
              Recuerde siempre que si usted esta en una situación de emergencia
              debe comunicarse con los teléfonos:{" "}
            </strong>
            *107 (SAME-Sistema de Atención Medica de Emergencia), *911
            (Emergencia policial), para atención telefónica inmediata. Si desea
            orientación telefónica a familiares y amigos, déjenos su mensaje y
      ...
      <div>
        ...
        <ul>
          ...
          <li>
            <strong>Telefono De La Esperanza: </strong> - 717-003-717 -
      ...
      <div>
        ...
        <ul>
          <li>
            <strong>LifeLine Australia: </strong>1-300-13-11-14
          </li>
          <li>
            <strong>Lifeline.org: </strong>
            <a>
      ...
      <div>
        ...
        <ul>
          <li>
            <strong>Beijing Suicide Research and Prevention Center: </strong>
            <a>http://www.crisis.org.cn/ </a>800-810-1117 (landline) or
            010-8295-1332 (mobile and VoIP callers)
          </li>
          <li>
            <strong>Shanghai Mental Health Center: </strong>
            <a>http://www.smhc.org.cn/</a>
          </li>
          <li>
            <strong>Lifeline Shanghai https: </strong>
      ...
      <div>
        ...
        <ul>
          ...
          <li>
            ...
            <a>http://www.crisisservicescanada.ca/en/</a>
          </li>
          <li>
            <strong>Canadian Association for Suicide Prevention: </strong>
